  ...
  return (
    <section className="w-full h-auto bg-[#F8F8F8] py-12 sm:py-16 md:py-20 lg:py-24 flex items-center justify-center">
      <div className="w-full max-w-5xl relative px-4 mx-auto space-y-8 flex flex-col items-center justify-center">
        <div className="w-full rounded-3xl relative bg-black text-white py-[50px] sm:py-24 lg:py-24 flex flex-col items-center justify-center space-y-6 ">
          ...
          <div className="w-full  z-50 flex flex-col items-center justify-center space-y-6 px-4 sm:px-8 ">
            <h1 className="font-extrabold text-white font-satoshibold text-xl sm:text-3xl md:text-4xl lg:text-[40px]">
              Protect What Matters Most
            </h1>
            <p className="text-white font-satoshi font-medium text-sm sm:text-base md:text-lg lg:text-xl md:w-full w-[70%] text-center">
          ...
          <div className="lg:w-full md:w-full w-full z-30 h-full absolute flex items-center justify-center -bottom-[54px] sm:-bottom-0 md:-bottom-[16px] lg:-bottom-[14px]">
            <Image
              src="/child.svg"
              alt="sacred-img"
              width={580}
