...
const SacredEye = () => {
  return (
    <section className="w-full h-auto bg-[#F8F8F8] py-12 sm:py-16 md:py-20 lg:py-24 flex items-center justify-center">
      <div className="w-full max-w-5xl relative px-4 mx-auto space-y-12 flex flex-col items-center justify-center">
        <div className="w-full rounded-3xl relative bg-black text-white py-20 sm:py-24 lg:py-28 flex flex-col items-center justify-center space-y-6 ">
          <div className="w-full rounded-2xl absolute z-40 top-0 left-0 bg-black/60 h-full" />
          ...
          <div className="lg:w-full md:w-full z-30 h-full absolute flex items-center justify-center -bottom-[38px] sm:-bottom-0 md:bottom-[2px] lg:-bottom-[14px]">
            <Image
              src="/child.svg"
              alt="sacred-img"
              width={580}
